...
t.test(mat1[,1], mat1[,6], alternative = "two.sided", var.equal = FALSE)
wilcox.test(mat1[,1], mat1[,6], alternative = "two.sided")

print("Face")
t.test(mat2[,1], mat2[,6], alternative = "two.sided", var.equal = FALSE)
wilcox.test(mat2[,1], mat2[,6], alternative = "two.sided")

print("House")
t.test(mat3[,1], mat3[,6], alternative = "two.sided", var.equal = FALSE)
wilcox.test(mat3[,1], mat3[,6], alternative = "two.sided")
